...
public class fees extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        profile.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                redirectActivity(fees.this, student_profile.class);
            }
        });
        class_work.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                redirectActivity(fees.this, class_work.class);
            }
        });
        home_work.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                redirectActivity(fees.this, home_work.class);
            }
        });
        attendance.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                redirectActivity(fees.this, attendance.class);
            }
        });
        fee.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                redirectActivity(fees.this, fees.class);
            }
        });
        result.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                redirectActivity(fees.this, exam_result.class);
            }
        });
        ...
        video_lecture.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                redirectActivity(fees.this, video_lecture.class);
            }
        });
        add_user.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                redirectActivity(fees.this, add_student.class);
            }
        });
        log_out.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                editor1.clear();
                editor1.commit();
                Intent intent = new Intent(fees.this,school_code.class);
