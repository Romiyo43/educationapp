...
public class video_lecture extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        profile.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                redirectActivity(video_lecture.this, student_profile.class);
            }
        });
        class_work.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                redirectActivity(video_lecture.this, class_work.class);
            }
        });
        home_work.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                redirectActivity(video_lecture.this, home_work.class);
            }
        });
        attendance.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                redirectActivity(video_lecture.this, attendance.class);
            }
        });
        fee.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                redirectActivity(video_lecture.this, fees.class);
            }
        });
        result.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                redirectActivity(video_lecture.this, exam_result.class);
            }
        });
        notification.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                redirectActivity(video_lecture.this, notification.class);
            }
        });
        video_lecture.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                redirectActivity(video_lecture.this, video_lecture.class);
            }
        });
        add_user.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                redirectActivity(video_lecture.this, add_student.class);
            }
        });
        log_out.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                editor1.clear();
                editor1.commit();
                Intent intent = new Intent(video_lecture.this,school_code.class);
